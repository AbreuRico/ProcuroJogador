        ...
        <section className={`${styles.container} py-50 px-6`}>
          ...
          <div className={styles.cardGroup}>
            <div className={styles.card}>
              <img src="/icons/free.svg" alt="Plano Gratuito" width={40} height={40} />
            ...
            <div className={`${styles.card} ${styles.destacado}`}>
              <img src="/icons/player-premium.svg" alt="Plano Premium Jogador" width={40} height={40} />
            ...
            <div className={styles.card}>
              <img src="/icons/olheiro-premium.svg" alt="Plano Olheiro Premium" width={40} height={40} />
